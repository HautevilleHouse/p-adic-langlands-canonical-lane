...
mkdir -p .tmp/p_adic_langlands
cp artifacts/stitch_constants.json .tmp/p_adic_langlands/stitch_constants.json
cp artifacts/constants_registry.json .tmp/p_adic_langlands/constants_registry.json
