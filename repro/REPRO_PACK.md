...
3. runs `scripts/pad_closure_guard.py` in strict coherence mode,
...
The certificate is a p-adic correspondence super-lane certificate. It records closure of the declared admissible p-adic correspondence lattice, not just one isolated p-adic correspondence example.
